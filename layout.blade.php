          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a href="./examples/landing" class="dropdown-item">Landing</a>
                <a href="./examples/profile" class="dropdown-item">Profil</a>
                <a href="./examples/login" class="dropdown-item">Login</a>
                <a href="./examples/register" class="dropdown-item">Créer un compte</a>
              </div>
            </li>
          </ul>
          @yield('content')
